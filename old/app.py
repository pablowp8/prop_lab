...
ENGINE_CONFIGS = {
    "OneSpoolEngine": {
        ...
        "runner": lambda p: sim.run_one_spool(
            ...
            pi_23=p["os_pi"], tit=p["os_tit"], eta_c=p["os_ec"], eta_t=p["os_et"],
        ),
    ...
    "SingleFlowTurbofan": {
        ...
        "sweep_params": lambda p: {
            "alt":p["tf_alt"],"t0_c":p["tf_t0"],"mach":p["tf_mach"],"G":p["tf_G"],
            "pi_23":p["tf_pi"],"tit":p["tf_tit"],"pi_fan":p["tf_pifan"],"bpr":p["tf_bpr"],
            "eta_c":p["tf_ec"],"eta_fan":p["tf_efan"],"eta_hpt":p["tf_ehpt"],"eta_lpt":p["tf_elpt"],
        },
    },
    "OneSpoolTurboprop": {
        "label":    "Turboprop",
        ...
        "sweep_params": lambda p: {
            "alt":p["tp_alt"],"t0_c":p["tp_t0"],"mach":p["tp_mach"],"G":p["tp_G"],
            "pi_23":p["tp_pi"],"tit":p["tp_tit"],"W_h":p["tp_Wh"]*1000,"eta_m":p["tp_etam"],
            "eta_c":p["tp_ec"],"eta_hpt":p["tp_ehpt"],"eta_lpt":p["tp_elpt"],
        },
    },
}
